...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=function(){function e(e,t){return new Promise(function(n,r){var s=new XMLHttpRequest;s.open("GET","http://cymoncommunity-dev-wartenuq33.elasticbeanstalk.com/api/nexus/v1/blacklist/domain/"+encodeURIComponent(e)+"/?days="+encodeURIComponent(p)+"&limit=25000"),s.onload=function(){if(200==s.status){var e=[];$.each(JSON.parse(s.response).results,function(t,n){e.push(n.name)}),n({domains:e,timestamp:t})}else r(Error(s.statusText))},s.onerror=function(){r(Error("There was an error fetching domains from Cymon."))},s.send()})}function t(t){var n=[];t.clear(),$.each(l,function(e,t){t&&n.push(e)}),n.length&&(b=(new Date).getTime(),$.each(n,function(n,r){e(r,b).then(function(e){e.timestamp==b&&(t.add(e.domains),chrome.runtime.sendMessage({action:"updateEvent"}))})}),this.setLastFetch((new Date).getTime()))}function n(){y&&clearTimeout(y),y=setTimeout(function(){chrome.runtime.sendMessage({action:"fetchEvent"})},v>0?v+36e5*d-(new Date).getTime():0)}function r(e){return e&&"object"==typeof e&&Object.keys(l).sort().toString()===Object.keys(e).sort().toString()&&JSON.stringify(l)!=JSON.stringify(e)?(l=JSON.parse(JSON.stringify(e)),chrome.storage.sync.set({tags:l}),!0):!1}function s(e){return e&&"number"==typeof e&&e!=p&&e%1===0&&e>0&&3>=e?(p=e,chrome.storage.sync.set({fetchLookback:p}),!0):!1}function o(e,t,n){var o=r(e),c=s(t);this.setFetchInterval(n),(o||c)&&chrome.runtime.sendMessage({action:"fetchEvent"})}function c(e){var t=r(e);return t&&chrome.runtime.sendMessage({action:"fetchEvent"}),t}function a(e){var t=s(e);return t&&chrome.runtime.sendMessage({action:"fetchEvent"}),t}function i(e){return e&&"number"==typeof e&&e%1===0&&e>0&&24>=e?(d=e,chrome.storage.sync.set({fetchInterval:d}),this.updateFetchTimer(),!0):!1}function u(e){return e&&"number"==typeof e&&e%1==0?(v=e,chrome.storage.sync.set({lastFetch:v}),this.updateFetchTimer(),!0):!1}function m(){return JSON.parse(JSON.stringify(l))}function h(){return p}function f(){return d}function g(){return v}var l={blacklist:!1,botnet:!1,dnsbl:!0,"malicious activity":!1,malware:!1,phishing:!1,spam:!1},p=1,d=24,v=0,y=0,b=0;return chrome.storage.sync.get(function(e){l=e.tags||l,p=e.fetchLookback||p,d=e.fetchInterval||d,v=e.lastFetch||v}),{fetchBlacklist:t,updateFetchTimer:n,save:o,setTags:c,setFetchLookback:a,setFetchInterval:i,setLastFetch:u,getTags:m,getFetchLookback:h,getFetchInterval:f,getLastFetch:g}}(),module.exports=exports["default"];
},{}],4:[function(require,module,exports){
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=function(){function e(){return JSON.parse(JSON.stringify(s))}function t(e){return"string"==typeof e&&-1==s.indexOf(e)?(s.push(e),chrome.storage.sync.set({whitelist:s}),chrome.runtime.sendMessage({action:"updateEvent"}),!0):!1}function n(e){if("string"==typeof e){var t=s.indexOf(e);return-1!=t?(s.splice(t,1),chrome.storage.sync.set({whitelist:s}),chrome.runtime.sendMessage({action:"updateEvent"}),!0):!1}return!1}function r(){s=[],chrome.storage.sync.set({whitelist:[]}),chrome.runtime.sendMessage({action:"updateEvent"})}var s=[];return chrome.storage.sync.get(function(e){s=e.whitelist||s}),{get:e,add:t,remove:n,clear:r}}(),module.exports=exports["default"];
},{}]},{},[1])
