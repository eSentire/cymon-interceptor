...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports["default"]=function(){function e(e,t){return new Promise(function(n,o){var s=new XMLHttpRequest;s.open("GET","http://cymoncommunity-dev-wartenuq33.elasticbeanstalk.com/api/nexus/v1/blacklist/domain/"+encodeURIComponent(e)+"/?days="+encodeURIComponent(f)+"&limit=25000"),s.onload=function(){if(200==s.status){var e=[];$.each(JSON.parse(s.response).results,function(t,n){e.push(n.name)}),n({domains:e,timestamp:t})}else o(Error(s.statusText))},s.onerror=function(){o(Error("There was an error fetching domains from Cymon."))},s.send()})}function t(t){var n=[];t.set([]),$.each(h,function(e,t){t&&n.push(e)}),n.length&&(g=(new Date).getTime(),$.each(n,function(n,o){e(o,g).then(function(e){e.timestamp==g&&(t.add(e.domains),chrome.runtime.sendMessage({action:"updateEvent"}))})}),this.setLastFetch((new Date).getTime()))}function n(){return d&&clearTimeout(d),d=setTimeout(function(){chrome.runtime.sendMessage({action:"fetchEvent"})},p>0?p+36e5*l-(new Date).getTime():0),!0}function o(e){return e&&"object"==typeof e?(h=e,chrome.storage.sync.set({tags:h}),chrome.runtime.sendMessage({action:"fetchEvent"}),!0):!1}function s(e){return e&&"number"==typeof e&&e%1===0&&e>0&&3>=e?(f=e,chrome.storage.sync.set({fetchLookback:f}),!0):!1}function r(e){return e&&"number"==typeof e&&e%1===0&&e>0&&24>=e?(l=e,chrome.storage.sync.set({fetchInterval:l}),this.updateFetchTimer(),!0):!1}function c(e){return e&&"number"==typeof e&&e%1==0?(p=e,chrome.storage.sync.set({lastFetch:p}),this.updateFetchTimer(),!0):!1}function a(){return h}function i(){return f}function u(){return l}function m(){return p}var h={blacklist:!1,botnet:!1,dnsbl:!0,"malicious activity":!1,malware:!1,phishing:!1,spam:!1},f=1,l=24,p=0,d=0,g=0;return chrome.storage.sync.get(function(e){h=e.tags||h,f=e.fetchLookback||f,l=e.fetchInterval||l,p=e.lastFetch||p}),{fetchBlacklist:t,updateFetchTimer:n,setTags:o,setFetchLookback:s,setFetchInterval:r,setLastFetch:c,getTags:a,getFetchLookback:i,getFetchInterval:u,getLastFetch:m}}(),module.exports=exports["default"];
